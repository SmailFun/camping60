                            ...
                            <div class="searchable-items list">
                                <div class="items items-header-section">
                                    <div class="item-content">
                                        <div class="column">
                                            <h4 style="margin-left: 3px;">Дата заказа</h4>
                                        </div>
                                        <div class="column">
                                            <h4  style="margin-left: 3px;">Категория товара</h4>
                                        </div>
                                        <div class="column">
                                            <h4  style="margin-left: 3px;">Колличество</h4>
                                        </div>
                                        <div class="column">
                                            <h4  style="margin-left: 3px;">Сумма заказа</h4>
                                        </div>
                                        <div class="column">
                                            <h4 style="margin-left: 3px;">Адресс доставки</h4>
                                        </div>
                                        <div class="column">
                                            <h4 style="margin-left: 3px;">Статус заказа</h4>
                                        </div>
                                    </div>
                                </div>
                              {{--  @foreach($data as $el)
