        ...
        <div class="navbar-header">
            <div class="basic-wrapper">
                ...
                <div class="navbar-brand">
                    <a href="/">
                        <img src="#" srcset="{{ asset("style/images/logohouse.png") }}" class="logo-light" style=" margin-left: 30px;" alt="" />
                        <img src="#" srcset="{{ asset("style/images/logohouse.png") }}" class="logo-dark" style=" margin-left: 30px;" alt="" />
                    </a>
                </div>
                <!-- /.navbar-brand -->
            </div>
            ...
            <ul class="nav navbar-nav">
                <li class="current dropdown"><a href="/" class="dropdown-toggle js-activated" data-toggle="dropdown">Главная<span class="caret"></span></a>
                    <ul class="dropdown-menu">
                        ...
                        <li><a href="/smolenka">Кемпинг Смоленка</a></li>
                        <li><a href="/pskovhouse">Дома Псков</a></li>
                    </ul>
                </li>
