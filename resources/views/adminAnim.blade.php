...
@section('content')
    ...
    <div id="content" class="main-content">
                    ...
                    <div class="container">
                        ...
                        <div id="navSection" data-spy="affix" class="nav  sidenav">
                            <div class="sidenav-content" style="margin-right: 8px">
                                ...
                                <a href="#9" class="nav-link">Таблица</a>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-10 col-12 mx-auto">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="t-text" class="sr-only">Text</label>
                                                <input form="a1" id="t-text" type="text"
                                                       name="animText2" class="form-control">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-10 col-12 mx-auto">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <label for="t-text" class="sr-only">Text</label>
                                                <input form="a1" id="t-text" type="text"
                                                       name="textBigL" class="form-control"
                                                       required>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-10 col-12 mx-auto">
                                            <div class="form-group">
                                                ...
                                                <label for="t-text" class="sr-only">Text</label>
                                                <input form="a1" id="t-text" type="text"
                                                       name="textBigR" class="form-control"
                                                       required>
        ...
        <div class="widget-content widget-content-area">
    <div id="9" class="row layout-top-spacing ">
        <div class="table-responsive">
            <table
                ...
                <tr>
                    ...
                    <th>Текст анимационный (первый)</th>
                    <th>Текст анимационный (второй)</th>
