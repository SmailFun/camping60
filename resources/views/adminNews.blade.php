                    ...
                    <div class="container">
                        ...
                        <div id="navSection" data-spy="affix" class="nav  sidenav">
                            <div class="sidenav-content">
                                ...
                                <a href="#2" class="nav-link">Текст новости</a>
                                ...
                                <div class="widget-content widget-content-area">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8 col-12 mx-auto">
                                            <form method="post" id="asd" name="a1"
                                                  action="{{ route('news','newsid') }}"
                                    ...
                                    <div id="2" class="widget-header">
                                        <div class="row">
                                            ...
                                            <textarea form="asd" class="form-control" id="exampleFormControlTextarea1"
                                                      name="textDown" rows="3"></textarea>
                                        </div>
                                    </div>
                                ...
                                <table class="table table-bordered table-hover table-striped mb-4">
                                    ...
                                    @foreach($data as $el)
                                        <tr>
                                            ...
                                            <td>{{ $el-> textUp }}</td>
                                            <td>{{ $el-> textDown }}</td>
                                            <td><img width="150" height="100" src="{{asset('storage/'.$el->photo)}}">
                                            </td>
                                            <td>
                                                <a href="{{route('newsid', $el->id)}}">
                                                    <button class="mt-4 mb-4 btn btn-primary">редактировать
                                                    </button>
                                                </a>
