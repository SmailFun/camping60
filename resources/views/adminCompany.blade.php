                ...
                <div class="row layout-top-spacing">
                    ...
                    <div id="basic" class="col-lg-12 layout-spacing">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <textarea form="asd" class="form-control" id="exampleFormControlTextarea1" name="textAR" rows="3"></textarea>
                                        ...
                                        <div class="col-lg-6 col-12 mx-auto">
                                            <form method="post">
                                                <div class="form-group">
                                                    ...
                                                    <input id="range-text" type="range" name="range" class="form-control" form="asd">
                                                </div>
                                            </form>
                                        </div>
