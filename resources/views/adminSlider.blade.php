                    ...
                    <div class="container">
                        ...
                        <div class="row layout-top-spacing ">
                            ...
                            <div class="statbox widget box box-shadow">
                                ...
                                <div id="3" class="widget-header" style="display: none;">
                                    <div class="row">
                                        <div class="mt-5 col-md-10 col-10 mx-auto">
                                            <h3>Cсылка</h3>
                                        </div>
                                ...
                                <div class="widget-content widget-content-area" style="display: none;">

                                    <div class="row">

                                        <div class="mt-2 col-md-10 col-10 mx-auto">
